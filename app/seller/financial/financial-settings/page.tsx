...
import { MdAdd, MdDeleteForever, MdNavigateNext } from "react-icons/md";
export default function FinancialSettings() {
    ...
    return (
        <div className="p-6 max-w-[1536px] w-full m-auto">
            <div className='flex items-center mb-2'> <h1 className="text-xl font-bold text-gray-600 ">Quản lí tài chính</h1> <MdNavigateNext className='text-xl' />  <h1 className="text-xl font-bold">Cài đặt</h1></div>
            <div>
                <div className="flex justify-between bg-white items-center  px-6 py-4">
                    ...
                    <button onClick={() => openModal('modal2')} className="p-2 flex justify-center items-center bg-primary rounded-lg shadow-md text-white font-semibold text-sm">
                        ...
                        <span className='hidden md:block lg:block'> Thêm tài khoản</span>
                    </button>
                                    ...
                                    <div className="bg-white p-4 z-50 w-full h-full md:h-auto  md:w-3/6 md:rounded-xl  lg:h-auto lg:rounded-xl lg:w-528" >
                                        ...
                                        <div>
                                            ...
                                            <div className="flex justify-end">
                                                <button onClick={() => closeModal('modal2')} className="rounded-lg text-black font-semibold text-sm bg-gray-50 px-4 py-2 mr-2">Huỷ</button>
