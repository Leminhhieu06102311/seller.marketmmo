            ...
            <div className='flex flex-col md:flex-row lg:flex-row justify-between items-start'>
                <div className='w-full md:w-[48%] mb-5 lg:w-[48%]  bg-white px-6 py-4 shadow-lg rounded-lg'>
                    ...
                    <div className='mb-2'>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='text-gray-500 text-lg'><span className='font-bold text-black'>0</span> đ</div>
                            <button className='px-5 py-2 bg-primary rounded-lg text-white font-semibold'>Rút</button>
                        </div>
                    </div>
                    <div>
                        <div className='text-sm font-medium text-gray-500'>Bạn có thể rút tiền một lần sau mỗi 24h</div>
                        <div className='text-sm font-medium text-gray-500'>Bật tự động rút tiền. <a href="" className='text-primary text-sm font-bold'> Tại đây</a> </div>
                    </div>
                </div>
                <div className='w-full md:w-[48%] mb-5 lg:w-[48%] bg-white px-6 py-4 shadow-lg rounded-lg'>
                    <div className='flex items-center justify-between'>
                    ...
                    <div className='mb-2'>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='text-black font-semibold text-lg'>99335036556</div>
                            <button className='px-5 py-2 bg-blue-50 border-blue-800 text-primary rounded-lg  font-semibold uppercase'>Tên chủ thẻ</button>
                        </div>
                    </div>
                    <div>
