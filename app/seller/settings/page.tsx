                        ...
                        <div className='flex flex-col justify-between md:flex-row lg:flex-row'>
                            <div className='flex flex-col mb-3 justify-center md:mr-[50px] lg:mr-[50px]'>
                                ...
                                <div className='flex flex-row items-center justify-center px-1 w-full md:flex-col md:px-0 lg:flex-col lg:px-0'>
                                    <div className='rounded-full overflow-hidden'> <Image src="/images/product/1.webp" alt='' width={109} height={109}></Image></div>
                                                    ...
                                                    <div className="fixed inset-0 flex items-center justify-center z-50">
                                                        ...
                                                        <div className="bg-white p-4 z-50 w-full h-full md:h-auto  md:w-[528px] md:rounded-xl  lg:h-auto lg:rounded-xl lg:w-[528px]" >
                                                            <div className="flex justify-between mb-5">
                                                                ...
                                                                <button className='text-2xl pr-1 text-gray-400' onClick={() => closeModal('modal1')}><IoMdClose /></button>
                                                            </div>
                                                            <div className="">
                                                                <h3 className='font-semibold text-base mb-3'>Tuỳ chỉnh</h3>
                                                                <div className=''>
                                                                    <div className="flex justify-between items-center mb-5">
                                                                        <Image className='rounded-full' alt={''} src='/images/product/1.webp' width={80} height={80} ></Image>
                                                                        <div className='flex items-center'>
                                                                            <input
                                                                                type="file"
                                                                                ref={fileInputRef}
                                                                            ...
                                                                            />
                                                                            <button onClick={handleFileSelect} className='bg-primary hover:bg-[#3459e7] text-white px-4 py-3 rounded-lg text-sm font-semibold'><span className='mr-2'>a</span> Upload</button>
                                                                        </div>
                                                                    </div>
                                                                    <div className='mb-5'>
                                                                        <ul>
                                                    ...
                                                    <div className="fixed inset-0 flex items-center justify-center z-50">
                                                        ...
                                                        <div className="bg-white p-4 z-50 w-full h-full md:h-auto  md:w-[528px] md:rounded-xl  lg:h-auto lg:rounded-xl lg:w-[528px]" >
                                                            <div className="flex justify-between mb-5">
                                                                ...
                                                                <button className='text-2xl pr-1 text-gray-400' onClick={() => closeModal('modalinf1')}><IoMdClose /></button>
                                                            </div>
                                                            <div className="">
                                                                <div>
                                                                    ...
                                                                    <span className='text-xs font-normal'>Bạn có thể đổi tên cửa hàng 1 lần trong 1 tháng</span>
                                                                </div>
                                                                <div className='flex justify-end items-center'>
                                                    ...
                                                    <div className="fixed inset-0 flex items-center justify-center z-50">
                                                        ...
                                                        <div className="bg-white p-4 z-50 w-full h-full md:h-auto  md:w-[528px] md:rounded-xl  lg:h-auto lg:rounded-xl lg:w-[528px]" >
                                                            <div className="flex justify-between mb-5">
                                                                ...
                                                                <button className='text-2xl pr-1 text-gray-400' onClick={() => closeModal('modalinf2')}> <IoMdClose /></button>
                                                            </div>
                                                            <div className="">
                                                    ...
                                                    <div className="fixed inset-0 flex items-center justify-center z-50">
                                                        ...
                                                        <div className="bg-white p-4 z-50 w-full h-full md:h-auto  md:w-[528px] md:rounded-xl  lg:h-auto lg:rounded-xl lg:w-[528px]" >
                                                            <div className="flex justify-between mb-5">
                                                                ...
                                                                <button className='text-2xl pr-1 text-gray-400' onClick={() => closeModal('modalinf3')}><IoMdClose /></button>
                                                            </div>
                                                            <div className="">
                                                                <div className='mb-4'>
                                                        ...
                                                        <div className="fixed inset-0 flex items-center justify-center z-50">
                                                            ...
                                                            <div className="bg-white p-4 z-[52] w-full h-full md:h-auto  md:w-[528px] md:rounded-xl  lg:h-auto lg:rounded-xl lg:w-[528px]" >
                                                                <div className="flex justify-end mb-1">
                                                                    <button className='text-2xl pr-1 text-gray-400' onClick={() => closeModal('modal2')}>  <IoMdClose /></button>
                                                                </div>
                                                                <div className="">
                                                        ...
                                                        <div className="fixed inset-0 flex items-center justify-center z-50">
                                                            ...
                                                            <div className="bg-white p-4 z-50 w-full h-full md:w-[400px] md:h-auto md:rounded-xl lg:w-[400px] lg:h-auto lg:rounded-xl">
                                                                <div className="flex justify-between items-center mb-3">
                                                                    ...
                                                                    <button className='text-2xl pr-1 text-gray-400' onClick={() => closeModal('modal3')}> <IoMdClose /></button>
                                                                </div>
                                                                <div className="mb-5">
                        ...
                        <div className='mb-2'>
                            ...
                            <div className='flex flex-col justify-between md: lg:flex-row'>
                                ...
                                <div className='flex justify-between' >
                                    ...
                                    <Link href='/settings/account-activity' className='bg-white border text-center border-gray-300 rounded-lg font-semibold text-sm px-6 py-3 hover:bg-[#f8fafd]'>Quản lý</Link>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className='flex justify-between flex-col md:flex-row lg:flex-row'>
                                ...
                                <Link href='/settings/device-management' className='bg-white border text-center border-gray-300 px-4 rounded-lg font-semibold text-sm py-2 hover:bg-[#f8fafd]'>Xem thêm</Link>
                            </div>
                        </div>
                    </div>
                </div>
