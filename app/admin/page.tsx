...
export default function Admin({}) {
  ...
  useEffect(() => {
    const DashBoard = async () => {
      ...
      const res = await getDashBoard(token, startDate, endDate);
      setDashboard(res);
      setLoadingPage(false);
    };
        ...
        <div className="p-6 max-w-[1536px] w-full m-auto">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-x-4 text-sm items-center">
              <div
                className={`flex gap-x-2 items-center rounded-md px-5 py-2 cursor-pointer hover:bg-gray-200 ${
                  selectedType === "Ngày" && "bg-gray-200"
                }`}
              ...
              <div
                className={`flex gap-x-2 items-center rounded-md px-5 py-2 cursor-pointer hover:bg-gray-200 ${
                  selectedType === "Tháng" && "bg-gray-200"
                }`}
