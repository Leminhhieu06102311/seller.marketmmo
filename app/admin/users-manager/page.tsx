...
export default function UsersManager() {
  ...
  useEffect(() => {
    const getUser = async () => {
      ...
      setCountUser(sortedUsers.length);
  ...
  const handleButtonClick = (userId: string) => {
    ...
    if (selectedUser) {
      router.push(`/admin/users-manager/${selectedUser._id}`);
    }
  };
  ...
  const hanldeDelete = async (idUser: string, status: string) => {
    toast.promise(DeleteUser(idUser, status, token), {
      ...
      error: {
        render: () => {
          return <div>Lỗi khi chỉnh sửa trạng thái. Thử lại sau!</div>;
        },
      },
    });
  };
                                ...
                                <tr className="bg-white border-t hover:bg-gray-50 cursor-pointer">
                                  ...
                                  <td className="p-4 text-sm">
                                    {users.deletedAt === null && (
                                      <span
                                        onClick={() =>
                                          openModalDelete(users._id)
                                        }
                                        className="text-[green] bg-green-50 border rounded-lg border-[green] px-3 py-1 text-xs"
                                      >
                                        Active
                                      </span>
                                    )}
                                    {users.deletedAt !== null && (
                                      <span
                                        ...
                                        className="text-[red] bg-red-50 border rounded-lg border-[red] px-3 py-1 text-xs"
                                      >
                                        Ban
                                      </span>
                                    )}
                              ...
                              <div>
                                ...
                                <div className="flex justify-center">
                                  ...
                                  {users.deletedAt !== null && (
                                    <button
                                      onClick={() =>
                                        hanldeDelete(users._id, StatusUnBan)
                                      }
                                      className="rounded-lg text-white font-semibold text-sm bg-primary px-4 py-2"
                                    >
                                      Tắt
