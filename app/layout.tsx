                ...
                <div className="md:px-6 lg:px-[40px] ">
                  <div className="flex items-center justify-between h-[80px]">
                    <div className="flex items-center">
                      <button
                        onClick={openModal}
                        className="inline-flex items-center relative justify-center p-2 text-[1.5rem] cursor-pointer w-10 h-10 hover:bg-[#63738114] rounded-full  md:block lg:hidden"
                      >
                        <FiMenu className="w-5 h-5" />
                      </button>
                      <button
                        onClick={openSearch}
                        className="inline-flex items-center relative justify-center p-2 text-[1.5rem] cursor-pointer w-10 h-10 hover:bg-[#63738114] rounded-full"
                      >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="">
                        <button
                          ...
                          className="inline-flex relative items-center justify-center p-2 text-[1.5rem] w-10 h-10 hover:bg-[#63738114] rounded-full"
                        >
            ...
            <div className="flex relative ">
              ...
              <div className="h-full sticky top-0 ">
                <div className=" flex-shrink-0 w-[280px] h-screen p-0 overflow-scroll scroll-auto border-r hidden  lg:block">
                  <div className="">
                    <div className="text-xl font-bold w-full text-center p-7">
                      Market MMO
                    </div>
                    <div className="my-6 mx-5 py-4 px-5 rounded-xl bg-[#919eab1f] flex ">
                      ...
                      <div className="flex items-center ml-4">
                        <h6 className="font-semibold text-[0.875rem">
                          Lê Minh Hiếu
                        </h6>
                      </div>
                    </div>
                    <nav className="px-4 ">
                      <Link
                        href="/"
                        className="mb-1 text-sm rounded-md capitalize text-primary font-semibold py-2 px-4 min-h-[44px] flex items-center cursor-pointer bg-[#1877f214]"
                      >
                        <AiFillDashboard className="w-6 h-6 mr-4" />
                        <span>Dashboard</span>
                      </Link>
                      <Link
                        href="/products-manager"
                        className="mb-1 text-sm rounded-md capitalize text-[#637381] font-semibold py-2 px-4 min-h-[44px] flex items-center cursor-pointer hover:bg-[#919eab14] transition-all"
                      >
                        <FaCartShopping className="w-6 h-6 mr-4" />
                        <span>Sản phẩm</span>
                      </Link>
                      <Link
                        href="/financial"
                        className="mb-1 text-sm rounded-md capitalize text-[#637381] font-semibold py-2 px-4 min-h-[44px] flex items-center cursor-pointer hover:bg-[#919eab14] transition-all"
                      >
                        <FaCreditCard className="w-6 h-6 mr-4" />
                        <span>Tài chính</span>
                      </Link>
                      <Link href="/users-manager" className="mb-1 text-sm rounded-md capitalize text-[#637381] font-semibold py-2 px-4 min-h-[44px] flex items-center cursor-pointer hover:bg-[#919eab14] transition-all"><FaUser className="w-6 h-6 mr-4" /><span>Quản lí người dùng</span></Link>
                      ...
                      <Link
                        ...
                        className="mb-1 text-sm rounded-md capitalize text-[#637381] font-semibold py-2 px-4 min-h-[44px] flex items-center cursor-pointer hover:bg-[#919eab14] transition-all"
                      >
                        <FaFileInvoice className="w-6 h-6 mr-4" />
                  ...
                  <div className="flex items-start justify-start min-h-screen pt-4 px-4 pb-20 text-left sm:block sm:p-0">
                    ...
                    <div className="w-full h-full fixed right-0  top-0 md:top-[45px] md:right-[105px] lg:right-[125px] rounded-lg shadow-lg  lg:top-[45px]  bg-white  md:h-[80vh] md:w-[380px] lg:h-[80vh] lg:w-[380px]">
                      <div className=" overflow-scroll scroll-auto w-full h-full">
                        ...
                        <h3 className="text-sm py-1 mb-3 px-6 border-b font-semibold ">
                          MỚI
                        </h3>
                        <div>
                          <div className="hover:bg-gray-50 bg-gray-100 px-6 py-4">
                            <div className="flex items-center">
                              <div className="w-10 h-10 bg-gray-50 p-2 rounded-full overflow-hidden mr-4">
                                <Image
                                  src="/images/promotion/businessman.png"
                                  alt=""
                                  width={40}
                                  height={40}
                                />
                              ...
                              <div className="text-sm">
                                ...
                                <div className="font-medium text-xs flex items-center text-gray-400">
                                  <FaRegClock className="mr-1" /> 1 tiếng trước
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <h3 className="text-sm py-1 my-3 px-6 border-y font-semibold ">
                          ĐÃ ĐỌC
                        </h3>
                        <div>
                        ...
                        <div className="w-full text-primary py-2 px-6 border-y text-center">
                          <h5 className="w-full py-1 rounded-lg hover:bg-blue-50">
                            Xem thêm
                          </h5>
                        </div>
                      </div>
                ...
                {searchModallOpen && (
                  <div className="relative inset-0  items-center justify-center z-50 ">
                    ...
                    <div className="absolute shadow-lg right-0 bg-[#f9fafbcc] bg-blur-[6px] w-full h-[80px]  animate__animated animate__slideInDown animate__faster flex items-center lg:px-10 ">
                      <button className="inline-flex items-center relative justify-center p-2 text-[1.5rem] cursor-pointer w-10 h-10 hover:bg-[#63738114] rounded-full">
                        <IoIosSearch className="w-5 h-5" />
                      </button>
                      <input
                        type="text"
                        ...
                        placeholder="Search..."
                      />
                      <button className="px-4 py-[6px] bg-primary text-white font-semibold rounded-xl">
                        Search
                      </button>
                    </div>
                  </div>
                )}
                <div className="pt-[88px] px-4 w-full">{children}</div>
              </div>
            </div>
          </div>
