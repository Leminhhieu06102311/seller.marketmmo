              ...
              <div className="">
                ...
                <nav className="px-4 ">
                  {links && links.map((link) => (
                    ...
                    <Link href={link.path} className={`mb-1 text-sm rounded-md capitalize  font-semibold py-2 px-4 min-h-[44px] flex items-center cursor-pointer hover:bg-white ${link.path === pathName ? 'bg-[#1877f214] text-primary': 'text-black '}`}>{link.icon}<span>{link.name}</span></Link>
